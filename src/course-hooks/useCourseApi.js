...
const useCourseApi = () => {
  ...
  const getAllMyCourses = useCallback(() => fetchData('/courses/byInstructor', { method: 'GET' }), [fetchData]);
  ...
  return {
    ...
    getAllCourseVersions, getCourseVersionById, getDraftCourseById, getCourseByInstructorId, getAllMyCourses,
    getStudentCourse
  };
};
