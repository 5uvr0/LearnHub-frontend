                    ...
                    <div>
                        ...
                        {isTeacherView && (
                            <small className="text-muted">
                                Content ID: {content?.id} | Current Release: {content?.currentContentRelease?.releaseNum || 'N/A'}
            ...
            {!isTeacherView && currentReleaseForDisplay && (
                <div className="mt-2">
                    ...
                    {currentReleaseForDisplay?.resourceLink && (
                        <p className="mb-1">Resource: <a href={currentReleaseForDisplay.resourceLink} target="_blank" rel="noopener noreferrer">Download <FontAwesomeIcon icon={faExternalLinkAlt} size="xs" /></a></p>
                    )}
                </div>
            )}
        </ListGroup.Item>
